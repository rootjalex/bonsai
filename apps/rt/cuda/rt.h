...
__device__ cuda::std::array<float4, 3> dequantize_orientation(cuda::std::array<char4, 3> x) {
  char4 _t0 = x[0];
  char4 _t4 = x[1];
  char4 _t8 = x[2];
...
__device__ cuda::std::optional<Triangle> _traverse_tree0(Ray* ray, Triangles* triangles) {
  ...
  do {
    ...
    uint64_t _t797 = slice<0, 1>(index);
    if (_t797 == 0u) {
      uint64_t _t10 = slice<10, 63>(index);
      for (uint64_t _idx0 = _t10; _idx0 < (_t10 + (uint64_t)(uint8_t)(slice<2, 9>(index) + 1u)); _idx0 += 1u) {
        Triangle _t9 = (*triangles).primitives[_idx0];
        if (intersectsp_ray_tri(ray, (&_t9)).has_value()) {
          float _t7 = distmin_Ray_Triangle(ray, (&_t9));
          if (_t7 < cuda::std::get<0>(_best0)) {
            _best0 = argmin(_best0, cuda::std::tuple<float, Triangle>{_t7, _t9});
          }
        }
      }
    } else {
      if (_t797 == 1u) {
        Aabbs _t29 = (*triangles).aabbs[slice<2, 63>(index)];
        cuda::std::array<float3, 8> _t30 = _t29.aabb_low;
        cuda::std::array<float3, 8> _t35 = _t29.aabb_high;
        AABB _t37 = AABB{_t30[0], _t35[0]};
        if (intersects_Ray_AABB(ray, (&_t37))) {
          if (distmin_Ray_AABB(ray, (&_t37)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t29.aabb_children[0u];
            _queue_count0 += 1;
          }
        }
        AABB _t63 = AABB{_t30[1], _t35[1]};
        if (intersects_Ray_AABB(ray, (&_t63))) {
          if (distmin_Ray_AABB(ray, (&_t63)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t29.aabb_children[1u];
            _queue_count0 += 1;
          }
        }
        AABB _t89 = AABB{_t30[2], _t35[2]};
        if (intersects_Ray_AABB(ray, (&_t89))) {
          if (distmin_Ray_AABB(ray, (&_t89)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t29.aabb_children[2u];
            _queue_count0 += 1;
          }
        }
        AABB _t115 = AABB{_t30[3], _t35[3]};
        if (intersects_Ray_AABB(ray, (&_t115))) {
          if (distmin_Ray_AABB(ray, (&_t115)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t29.aabb_children[3u];
            _queue_count0 += 1;
          }
        }
        AABB _t141 = AABB{_t30[4], _t35[4]};
        if (intersects_Ray_AABB(ray, (&_t141))) {
          if (distmin_Ray_AABB(ray, (&_t141)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t29.aabb_children[4u];
            _queue_count0 += 1;
          }
        }
        AABB _t167 = AABB{_t30[5], _t35[5]};
        if (intersects_Ray_AABB(ray, (&_t167))) {
          if (distmin_Ray_AABB(ray, (&_t167)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t29.aabb_children[5u];
            _queue_count0 += 1;
          }
        }
        AABB _t193 = AABB{_t30[6], _t35[6]};
        if (intersects_Ray_AABB(ray, (&_t193))) {
          if (distmin_Ray_AABB(ray, (&_t193)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t29.aabb_children[6u];
            _queue_count0 += 1;
          }
        }
        AABB _t219 = AABB{_t30[7], _t35[7]};
        if (intersects_Ray_AABB(ray, (&_t219))) {
          if (distmin_Ray_AABB(ray, (&_t219)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t29.aabb_children[7u];
            _queue_count0 += 1;
          }
        }
      } else {
        Obbs _t260 = (*triangles).obbs[slice<2, 63>(index)];
        float3 _t261 = _t260.mlo;
        float3 _t265 = _t260.mex;
        cuda::std::array<float3, 8> _t270 = cuda::std::array<float3, 8>{_t261 + ((make_float3(_t260.qlo[0].x, _t260.qlo[0].y, _t260.qlo[0].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qlo[1].x, _t260.qlo[1].y, _t260.qlo[1].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qlo[2].x, _t260.qlo[2].y, _t260.qlo[2].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qlo[3].x, _t260.qlo[3].y, _t260.qlo[3].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qlo[4].x, _t260.qlo[4].y, _t260.qlo[4].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qlo[5].x, _t260.qlo[5].y, _t260.qlo[5].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qlo[6].x, _t260.qlo[6].y, _t260.qlo[6].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qlo[7].x, _t260.qlo[7].y, _t260.qlo[7].z) / make_float3((float)255)) * _t265)};
        cuda::std::array<float3, 8> _t284 = cuda::std::array<float3, 8>{_t261 + ((make_float3(_t260.qhi[0].x, _t260.qhi[0].y, _t260.qhi[0].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qhi[1].x, _t260.qhi[1].y, _t260.qhi[1].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qhi[2].x, _t260.qhi[2].y, _t260.qhi[2].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qhi[3].x, _t260.qhi[3].y, _t260.qhi[3].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qhi[4].x, _t260.qhi[4].y, _t260.qhi[4].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qhi[5].x, _t260.qhi[5].y, _t260.qhi[5].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qhi[6].x, _t260.qhi[6].y, _t260.qhi[6].z) / make_float3((float)255)) * _t265), _t261 + ((make_float3(_t260.qhi[7].x, _t260.qhi[7].y, _t260.qhi[7].z) / make_float3((float)255)) * _t265)};
        cuda::std::array<float4, 3> _t290 = dequantize_orientation(_t260.qorientation);
        OBB _t291 = OBB{_t270[0], _t284[0], _t290};
        if (intersects_Ray_OBB(ray, (&_t291))) {
          if (distmin_Ray_OBB(ray, (&_t291)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t260.obb_children[0u];
            _queue_count0 += 1;
          }
        }
        OBB _t363 = OBB{_t270[1], _t284[1], _t290};
        if (intersects_Ray_OBB(ray, (&_t363))) {
          if (distmin_Ray_OBB(ray, (&_t363)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t260.obb_children[1u];
            _queue_count0 += 1;
          }
        }
        OBB _t435 = OBB{_t270[2], _t284[2], _t290};
        if (intersects_Ray_OBB(ray, (&_t435))) {
          if (distmin_Ray_OBB(ray, (&_t435)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t260.obb_children[2u];
            _queue_count0 += 1;
          }
        }
        OBB _t507 = OBB{_t270[3], _t284[3], _t290};
        if (intersects_Ray_OBB(ray, (&_t507))) {
          if (distmin_Ray_OBB(ray, (&_t507)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t260.obb_children[3u];
            _queue_count0 += 1;
          }
        }
        OBB _t579 = OBB{_t270[4], _t284[4], _t290};
        if (intersects_Ray_OBB(ray, (&_t579))) {
          if (distmin_Ray_OBB(ray, (&_t579)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t260.obb_children[4u];
            _queue_count0 += 1;
          }
        }
        OBB _t651 = OBB{_t270[5], _t284[5], _t290};
        if (intersects_Ray_OBB(ray, (&_t651))) {
          if (distmin_Ray_OBB(ray, (&_t651)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t260.obb_children[5u];
            _queue_count0 += 1;
          }
        }
        OBB _t723 = OBB{_t270[6], _t284[6], _t290};
        if (intersects_Ray_OBB(ray, (&_t723))) {
          if (distmin_Ray_OBB(ray, (&_t723)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t260.obb_children[6u];
            _queue_count0 += 1;
          }
        }
        OBB _t795 = OBB{_t270[7], _t284[7], _t290};
        if (intersects_Ray_OBB(ray, (&_t795))) {
          if (distmin_Ray_OBB(ray, (&_t795)) < cuda::std::get<0>(_best0)) {
            _queue0[_queue_count0] = _t260.obb_children[7u];
            _queue_count0 += 1;
          }
        }
      }
...
__host__ cuda::std::optional<Triangle>* _traverse_array0(int64_t n, Ray* rays, Triangles* triangles) {
  ...
  Aabbs* __aabbs;
  cudaMallocAndCopyToDevice((void**)&__aabbs, (*triangles).aabbs, (*triangles).aabb_count * sizeof(Aabbs));
  Obbs* __obbs;
  cudaMallocAndCopyToDevice((void**)&__obbs, (*triangles).obbs, (*triangles).obb_count * sizeof(Obbs));
...
__host__ cuda::std::array<uchar3, 8> quantize_bounds_high(cuda::std::array<float3, 8> low, cuda::std::array<float3, 8> high) {
  ...
  return cuda::std::array<uchar3, 8>{to_u8_ceil(((high[0] - mlo) / mex) * make_float3((float)255)), to_u8_ceil(((high[1] - mlo) / mex) * make_float3((float)255)), to_u8_ceil(((high[2] - mlo) / mex) * make_float3((float)255)), to_u8_ceil(((high[3] - mlo) / mex) * make_float3((float)255)), to_u8_ceil(((high[4] - mlo) / mex) * make_float3((float)255)), to_u8_ceil(((high[5] - mlo) / mex) * make_float3((float)255)), to_u8_ceil(((high[6] - mlo) / mex) * make_float3((float)255)), to_u8_ceil(((high[7] - mlo) / mex) * make_float3((float)255))};
}
...
__host__ cuda::std::array<uchar3, 8> quantize_bounds_low(cuda::std::array<float3, 8> low, cuda::std::array<float3, 8> high) {
  float3 mlo = min(low[0], min(low[1], min(low[2], min(low[3], min(low[4], min(low[5], min(low[6], low[7])))))));
  float3 mex = compute_merged_extent(low, high);
  return cuda::std::array<uchar3, 8>{to_u8_floor(((low[0] - mlo) / mex) * make_float3((float)255)), to_u8_floor(((low[1] - mlo) / mex) * make_float3((float)255)), to_u8_floor(((low[2] - mlo) / mex) * make_float3((float)255)), to_u8_floor(((low[3] - mlo) / mex) * make_float3((float)255)), to_u8_floor(((low[4] - mlo) / mex) * make_float3((float)255)), to_u8_floor(((low[5] - mlo) / mex) * make_float3((float)255)), to_u8_floor(((low[6] - mlo) / mex) * make_float3((float)255)), to_u8_floor(((low[7] - mlo) / mex) * make_float3((float)255))};
}
...
__host__ cuda::std::array<char4, 3> quantize_orientation(cuda::std::array<float4, 3> x) {
  float4 _t0 = x[0];
  float4 _t4 = x[1];
  float4 _t8 = x[2];
  return cuda::std::array<char4, 3>{char4{to_i8(_t0.x * (float)127), to_i8(_t0.y * (float)127), to_i8(_t0.z * (float)127), to_i8(_t0.w * (float)127)}, char4{to_i8(_t4.x * (float)127), to_i8(_t4.y * (float)127), to_i8(_t4.z * (float)127), to_i8(_t4.w * (float)127)}, char4{to_i8(_t8.x * (float)127), to_i8(_t8.y * (float)127), to_i8(_t8.z * (float)127), to_i8(_t8.w * (float)127)}};
}
...
__host__ uint64_t rec_build_triangles(BVH* node_, Triangles* ST, size_t* aabbs_index, size_t* obbs_index, size_t* primitives_index) {
  if (!node_) {
    ...
    if (std::holds_alternative<AABBNode>(*node_)) {
      ...
      return ((this_index << (uint64_t)4) | (uint64_t)1);
    }
    else if (std::holds_alternative<OBBNode>(*node_)) {
      const OBBNode& node = std::get<OBBNode>(*node_);
      size_t this_index = (*obbs_index);
      (*obbs_index) += 1;
      (*ST).obbs[this_index].mlo = min(node.obb_low[0], min(node.obb_low[1], min(node.obb_low[2], min(node.obb_low[3], min(node.obb_low[4], min(node.obb_low[5], min(node.obb_low[6], node.obb_low[7])))))));
      (*ST).obbs[this_index].mex = compute_merged_extent(node.obb_low, node.obb_high);
      (*ST).obbs[this_index].qlo = quantize_bounds_low(node.obb_low, node.obb_high);
      (*ST).obbs[this_index].qhi = quantize_bounds_high(node.obb_low, node.obb_high);
      ...
      return ((poffset << (uint64_t)10) | (((uint64_t)node.nprims - (uint64_t)1) << (uint64_t)2));
    }
}
