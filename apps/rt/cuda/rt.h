...
__host__ void _recloop_func0(uint64_t index, Ray *ray, Triangles *triangles,
    ...
    if (_t493 == 2u) {
        ...
        if (_t493 == 3u) {
            ...
            if (intersects_Ray_OBB(ray, (&_t241))) {
                if (distmin_Ray_OBB(ray, (&_t241)) <
                    cuda::std::get<0>((*_best0))) {
                    _recloop_func0(_t229.obb_children[0u], ray, triangles,
                                   _best0);
                }
            }
            OBB _t275 = OBB{_t230[1], _t235[1], _t240};
            if (intersects_Ray_OBB(ray, (&_t275))) {
                if (distmin_Ray_OBB(ray, (&_t275)) <
                    cuda::std::get<0>((*_best0))) {
                    _recloop_func0(_t229.obb_children[1u], ray, triangles,
                                   _best0);
                }
            }
            OBB _t309 = OBB{_t230[2], _t235[2], _t240};
            if (intersects_Ray_OBB(ray, (&_t309))) {
                if (distmin_Ray_OBB(ray, (&_t309)) <
                    cuda::std::get<0>((*_best0))) {
                    _recloop_func0(_t229.obb_children[2u], ray, triangles,
                                   _best0);
                }
            }
            OBB _t343 = OBB{_t230[3], _t235[3], _t240};
            if (intersects_Ray_OBB(ray, (&_t343))) {
                if (distmin_Ray_OBB(ray, (&_t343)) <
                    cuda::std::get<0>((*_best0))) {
                    _recloop_func0(_t229.obb_children[3u], ray, triangles,
                                   _best0);
                }
            }
            OBB _t377 = OBB{_t230[4], _t235[4], _t240};
            if (intersects_Ray_OBB(ray, (&_t377))) {
                if (distmin_Ray_OBB(ray, (&_t377)) <
                    cuda::std::get<0>((*_best0))) {
                    _recloop_func0(_t229.obb_children[4u], ray, triangles,
                                   _best0);
                }
            }
            OBB _t411 = OBB{_t230[5], _t235[5], _t240};
            if (intersects_Ray_OBB(ray, (&_t411))) {
                if (distmin_Ray_OBB(ray, (&_t411)) <
                    cuda::std::get<0>((*_best0))) {
                    _recloop_func0(_t229.obb_children[5u], ray, triangles,
                                   _best0);
                }
            }
            OBB _t445 = OBB{_t230[6], _t235[6], _t240};
            if (intersects_Ray_OBB(ray, (&_t445))) {
                if (distmin_Ray_OBB(ray, (&_t445)) <
                    cuda::std::get<0>((*_best0))) {
                    _recloop_func0(_t229.obb_children[6u], ray, triangles,
                                   _best0);
                }
            }
            OBB _t479 = OBB{_t230[7], _t235[7], _t240};
            if (intersects_Ray_OBB(ray, (&_t479))) {
                if (distmin_Ray_OBB(ray, (&_t479)) <
                    cuda::std::get<0>((*_best0))) {
                    _recloop_func0(_t229.obb_children[7u], ray, triangles,
                                   _best0);
                }
            }
        } else {
            uint64_t _t490 = slice<4, 63>(index);
            for (uint64_t _idx0 = _t490;
                 _idx0 < (_t490 + (uint64_t)(uint8_t)(slice<1, 8>(index) + 1u));
                 _idx0 += 1u) {
                ...
                if (intersectsp_ray_tri(ray, (&_t489)).has_value()) {
                    ...
                    if (_t487 < cuda::std::get<0>((*_best0))) {
                        (*_best0) = argmin(
                            _best0,
                            cuda::std::tuple<float, Triangle>{_t487, _t489});
                    }
                }
            }
        }
...
__host__ Triangles build_triangles(BVH *CT) {
    ...
    printf("p: %d a: %d, o: %d", ST.primitive_count, ST.aabb_count,
           ST.obb_count);
