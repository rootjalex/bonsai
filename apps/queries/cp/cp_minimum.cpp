...
std::tuple<Point, Point> closestPointonTriangle(const Point& pt, const Triangle& tri) {
  ...
  if (d1 <= 0.00000000f) {
    if (d2 <= 0.00000000f) {
      return std::tuple<Point, Point>{Point{a}, Point{float3{1.00000000f, 0.00000000f, 0.00000000f}}};
    }
  }
  const float3 bp = p - b;
  ...
  if (0.00000000f <= d3) {
    if (d4 <= d3) {
      return std::tuple<Point, Point>{Point{b}, Point{float3{0.00000000f, 1.00000000f, 0.00000000f}}};
    }
  }
  ...
  if (_t2 <= 0.00000000f) {
    if (0.00000000f <= d1) {
      if (d3 <= 0.00000000f) {
        ...
        return std::tuple<Point, Point>{Point{a + (float3{_t4} * ab)}, Point{vector<float, 3>({1.00000000f - _t4, _t4, 0.00000000f})}};
      }
    }
  }
  const float3 cp = p - c;
  ...
  if (0.00000000f <= d6) {
    if (d5 <= d6) {
      return std::tuple<Point, Point>{Point{c}, Point{float3{0.00000000f, 0.00000000f, 1.00000000f}}};
    }
  }
  ...
  if (_t7 <= 0.00000000f) {
    if (0.00000000f <= d2) {
      if (d6 <= 0.00000000f) {
        ...
        return std::tuple<Point, Point>{Point{a + (float3{_t9} * ac)}, Point{vector<float, 3>({1.00000000f - _t9, 0.00000000f, _t9})}};
      }
    }
  }
  ...
  if (_t12 <= 0.00000000f) {
    ...
    if (0.00000000f <= _t19) {
      ...
      if (0.00000000f <= _t18) {
        ...
        return std::tuple<Point, Point>{Point{b + (float3{_t17} * (c - b))}, Point{vector<float, 3>({0.00000000f, 1.00000000f - _t17, _t17})}};
      }
    }
  }
  ...
  return std::tuple<Point, Point>{Point{(a + (ab * float3{v})) + (ac * float3{w})}, Point{vector<float, 3>({u, v, w})}};
}
      ...
      if (_t532 == 0u) {
        ...
        if (_t9 < _t512) {
          ...
          if (_t25 < _t486) {
            ...
            const bool _t165 = (_t486 < _t512) | ((_t486 == _t512) & (_t9 < _t25));
            const uint32_t _sort_tmp0 = (_sort_cmp0 ? (_t165 ? _t14 : _t1) : (_t165 ? _t1 : _t14));
            const uint32_t _sort_tmp1 = (_sort_cmp0 ? (_t165 ? _t1 : _t14) : (_t165 ? _t14 : _t1));
        ...
        for (uint32_t _idx0 = 0u; _idx0 < _t532; _idx0 += 1u) {
          const float _t526 = distmin_Point_Triangle(p, tris.prims[_t534.offset + _idx0]);
          if (_t526 < _best0) {
