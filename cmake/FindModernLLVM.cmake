...
if (LLVM_FOUND AND NOT TARGET ModernLLVM::LLVM)
    ...
    if (ModernLLVM_SHARED_LIBS AND TARGET LLVM)
        ...
        # Use the list generated by LLVM's find_package itself.
        # This ensures all transitive dependencies (like Support) are included.
        target_link_libraries(ModernLLVM::LLVM INTERFACE ${LLVM_AVAILABLE_LIBS})
    endif ()
endif ()
