...
void emit_file(const std::string &filename,
    ...
    // codegen as of work-in-progress LLVM14. At the time of this comment
    // (Dec 2021), there is no firm plan as to when codegen will be fully
    // available in the new PassManager, so don't worry about this 'legacy'
